...
@font-face {
  ...
  src: url("/font/3270NerdFont-Regular.ttf") format("truetype");
}
...
@font-face {
  ...
  font-weight: 100 900;
  font-display: swap;
  src: url(https://fonts.gstatic.com/s/bigshoulderstext/v24/55xxezRtP9G3CGPIf49hxc8P0eytUxBclIZ6YsECdFQB.woff2) format('woff2');
...
@font-face {
  ...
  font-weight: 100 900;
  font-display: swap;
  src: url(https://fonts.gstatic.com/s/bigshoulderstext/v24/55xxezRtP9G3CGPIf49hxc8P0eytUxBclYZ6YsECdFQB.woff2) format('woff2');
...
@font-face {
  ...
  font-weight: 100 900;
  font-display: swap;
  src: url(https://fonts.gstatic.com/s/bigshoulderstext/v24/55xxezRtP9G3CGPIf49hxc8P0eytUxBcm4Z6YsECdA.woff2) format('woff2');
